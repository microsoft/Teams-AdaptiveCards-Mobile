...
Pod::Spec.new do |spec|
  ...
  spec.ios.private_header_files = 'source/ios/AdaptiveCardsSwift/Sources/AdaptiveCardsSwift/AdaptiveCardsSwift.h'
  
  # Source files - include both Swift files and umbrella header
  spec.source_files = 'source/ios/AdaptiveCardsSwift/Sources/AdaptiveCardsSwift/**/*.swift', 'source/ios/AdaptiveCardsSwift/Sources/AdaptiveCardsSwift/AdaptiveCardsSwift.h'
  ...
  spec.module_name = 'AdaptiveCardsSwift'
