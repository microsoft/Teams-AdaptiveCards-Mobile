...
public class ChainOfThoughtHostingView: UIView {
    ...
    func intrinsicContentSize() -> CGSize {
        return hostingController?.view.intrinsicContentSize ?? CGSize(width: UIView.noIntrinsicMetric, height: UIView.noIntrinsicMetric)
    }
    
    override public func systemLayoutSizeFitting(_ targetSize: CGSize) -> CGSize {
        return hostingController?.view.systemLayoutSizeFitting(targetSize) ?? targetSize
    }
}
