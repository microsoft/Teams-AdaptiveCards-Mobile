...
{
    if (rootView == nil || backgroundImage == nullptr || backgroundImage->GetUrl(Theme(rootView.theme)).empty()) {
        return;
    }

    std::string imageUrl = backgroundImage->GetUrl(Theme(rootView.theme));
