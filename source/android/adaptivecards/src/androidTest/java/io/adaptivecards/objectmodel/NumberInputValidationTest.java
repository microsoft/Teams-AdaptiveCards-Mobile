...
public class NumberInputValidationTest
{
    ...
    {
        NumberInputHandler numberInputHandler = new NumberInputHandler(numberInput, null, TestUtil.createMockRenderArgs(-1));
    ...
    private NumberInputHandler createCustomInputHandlerWithoutSpecificValidation(NumberInput numberInput)
    {
        ...
        {
            public CustomNumberInputHandler(BaseInputElement baseInputElement, FragmentManager fragmentManager) { super(baseInputElement, null, TestUtil.createMockRenderArgs(-1)); }
