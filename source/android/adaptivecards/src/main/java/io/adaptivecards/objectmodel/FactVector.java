...
public class FactVector extends java.util.AbstractList<Fact> implements java.util.RandomAccess {
  ...
  protected static long swigRelease(FactVector obj) {
    long ptr = 0;
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  private int doCapacity() {
    return AdaptiveCardObjectModelJNI.FactVector_doCapacity(swigCPtr, this);
  }

  private void doReserve(int n) {
    AdaptiveCardObjectModelJNI.FactVector_doReserve(swigCPtr, this, n);
  }
