...
public class ActionLayoutRenderer implements IActionLayoutRenderer {
        ...
        RenderArgs renderArgs) throws AdaptiveFallbackException
    {
        ...
        BaseCardElementRenderer.setSpacingAndSeparator(context, viewGroup, spacing, false, hostConfig,
            renderArgs.getContainerStyle(), true /* horizontalLine */, false /* isImageSet */);
