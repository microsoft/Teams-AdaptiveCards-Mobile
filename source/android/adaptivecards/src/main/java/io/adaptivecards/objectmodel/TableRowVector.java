...
public class TableRowVector extends java.util.AbstractList<TableRow> implements java.util.RandomAccess {
  ...
  protected static long swigRelease(TableRowVector obj) {
    long ptr = 0;
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  private int doCapacity() {
    return AdaptiveCardObjectModelJNI.TableRowVector_doCapacity(swigCPtr, this);
  }

  private void doReserve(int n) {
    AdaptiveCardObjectModelJNI.TableRowVector_doReserve(swigCPtr, this, n);
  }
