...
public class RemoteResourceInformationVector extends java.util.AbstractList<RemoteResourceInformation> implements java.util.RandomAccess {
  ...
  protected static long swigRelease(RemoteResourceInformationVector obj) {
    long ptr = 0;
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  private int doCapacity() {
    return AdaptiveCardObjectModelJNI.RemoteResourceInformationVector_doCapacity(swigCPtr, this);
  }

  private void doReserve(int n) {
    AdaptiveCardObjectModelJNI.RemoteResourceInformationVector_doReserve(swigCPtr, this, n);
  }
