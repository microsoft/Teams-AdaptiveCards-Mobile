...
public class TableColumnDefinitionVector extends java.util.AbstractList<TableColumnDefinition> implements java.util.RandomAccess {
  ...
  protected static long swigRelease(TableColumnDefinitionVector obj) {
    long ptr = 0;
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  private int doCapacity() {
    return AdaptiveCardObjectModelJNI.TableColumnDefinitionVector_doCapacity(swigCPtr, this);
  }

  private void doReserve(int n) {
    AdaptiveCardObjectModelJNI.TableColumnDefinitionVector_doReserve(swigCPtr, this, n);
  }
