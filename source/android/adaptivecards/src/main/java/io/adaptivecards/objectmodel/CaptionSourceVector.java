...
public class CaptionSourceVector extends java.util.AbstractList<CaptionSource> implements java.util.RandomAccess {
  ...
  protected static long swigRelease(CaptionSourceVector obj) {
    long ptr = 0;
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  private int doCapacity() {
    return AdaptiveCardObjectModelJNI.CaptionSourceVector_doCapacity(swigCPtr, this);
  }

  private void doReserve(int n) {
    AdaptiveCardObjectModelJNI.CaptionSourceVector_doReserve(swigCPtr, this, n);
  }
