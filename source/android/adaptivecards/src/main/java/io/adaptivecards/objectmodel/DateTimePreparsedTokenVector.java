...
public class DateTimePreparsedTokenVector extends java.util.AbstractList<DateTimePreparsedToken> implements java.util.RandomAccess {
  ...
  protected static long swigRelease(DateTimePreparsedTokenVector obj) {
    long ptr = 0;
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  private int doCapacity() {
    return AdaptiveCardObjectModelJNI.DateTimePreparsedTokenVector_doCapacity(swigCPtr, this);
  }

  private void doReserve(int n) {
    AdaptiveCardObjectModelJNI.DateTimePreparsedTokenVector_doReserve(swigCPtr, this, n);
  }
