...
public class InlineVector extends java.util.AbstractList<Inline> implements java.util.RandomAccess {
  ...
  protected static long swigRelease(InlineVector obj) {
    long ptr = 0;
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  private int doCapacity() {
    return AdaptiveCardObjectModelJNI.InlineVector_doCapacity(swigCPtr, this);
  }

  private void doReserve(int n) {
    AdaptiveCardObjectModelJNI.InlineVector_doReserve(swigCPtr, this, n);
  }
