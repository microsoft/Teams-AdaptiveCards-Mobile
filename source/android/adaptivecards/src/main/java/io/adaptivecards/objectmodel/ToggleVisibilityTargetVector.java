...
public class ToggleVisibilityTargetVector extends java.util.AbstractList<ToggleVisibilityTarget> implements java.util.RandomAccess {
  ...
  protected static long swigRelease(ToggleVisibilityTargetVector obj) {
    long ptr = 0;
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  private int doCapacity() {
    return AdaptiveCardObjectModelJNI.ToggleVisibilityTargetVector_doCapacity(swigCPtr, this);
  }

  private void doReserve(int n) {
    AdaptiveCardObjectModelJNI.ToggleVisibilityTargetVector_doReserve(swigCPtr, this, n);
  }
