...
public class AdaptiveCardParseWarningVector extends java.util.AbstractList<AdaptiveCardParseWarning> implements java.util.RandomAccess {
  ...
  protected static long swigRelease(AdaptiveCardParseWarningVector obj) {
    long ptr = 0;
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  private int doCapacity() {
    return AdaptiveCardObjectModelJNI.AdaptiveCardParseWarningVector_doCapacity(swigCPtr, this);
  }

  private void doReserve(int n) {
    AdaptiveCardObjectModelJNI.AdaptiveCardParseWarningVector_doReserve(swigCPtr, this, n);
  }
