...
public class BaseCardElementVector extends java.util.AbstractList<BaseCardElement> implements java.util.RandomAccess {
  ...
  protected static long swigRelease(BaseCardElementVector obj) {
    long ptr = 0;
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  private int doCapacity() {
    return AdaptiveCardObjectModelJNI.BaseCardElementVector_doCapacity(swigCPtr, this);
  }

  private void doReserve(int n) {
    AdaptiveCardObjectModelJNI.BaseCardElementVector_doReserve(swigCPtr, this, n);
  }
