...
public class ImageRenderer extends BaseCardElementRenderer
{
            ...
            RenderArgs renderArgs) throws Exception
    {
        ...
        if (isInImageSet)
        {
            separator = setSpacingAndSeparator(context, viewGroup, image.GetSpacing(), renderArgs.getContainerStyle(), image.GetSeparator(), hostConfig, false /* horizontal line */, true);
        }
