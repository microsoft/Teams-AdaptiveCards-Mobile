...
public class ImageRenderer extends BaseCardElementRenderer
{
            ...
            RenderArgs renderArgs) throws Exception
    {
        ...
        if (isInImageSet)
        {
            separator = setSpacingAndSeparator(context, viewGroup, image.GetSpacing(), image.GetSeparator(), renderArgs.getContainerStyle(), hostConfig, false /* horizontal line */, true);
        }
